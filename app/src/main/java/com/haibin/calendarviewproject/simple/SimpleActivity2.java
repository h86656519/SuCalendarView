...
public class SimpleActivity2  extends BaseActivity implements
    ...
    public static void show(Context context) {
        context.startActivity(new Intent(context, SimpleActivity2.class));
    }
