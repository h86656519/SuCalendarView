...
import com.haibin.calendarviewproject.calendarview.TestActivity2;
...
import com.haibin.calendarviewproject.simple.SimpleActivity2;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_simple:
               ...
               // SimpleActivity2.show(this);
                startActivity(new Intent().setClass(this, TestActivity2.class));
                break;
